...
<head>
    ...
    <title>Edit Education - Admin Panel</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <header class="admin-header">
        <div>
            ...
            <div class="breadcrumb">
                ...
                <a href="{{ route('admin.education.index') }}">Education</a> / Edit
            </div>
        </div>
        <div class="user-info">
    ...
    <div class="main-content">
        <div class="content-header">
            ...
            <p>Update education information</p>
        </div>
            ...
            <form method="POST" action="{{ route('admin.education.update', $education->id) }}">
                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <div class="help-text">e.g., Computer Science, Business Administration</div>
                    </div>
                    <div class="form-group">
                        <label for="grade">Grade/CGPA</label>
                        <input type="text" id="grade" name="grade" value="{{ old('grade', $education->grade) }}">
                        <div class="help-text">e.g., 3.8/4.0, First Class, A+</div>
                    </div>
                </div>
                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <input type="date" id="start_date" name="start_date" value="{{ old('start_date', $education->start_date ? $education->start_date->format('Y-m-d') : '') }}" required>
                    </div>
                    <div class="form-group">
                ...
                <div class="form-group full-width">
                    ...
                    <div class="help-text">Additional details about your education, coursework, achievements, etc.</div>
                </div>
                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <div class="help-text">City, Country</div>
                    </div>
                    <div class="form-group">
                        <label for="order">Display Order</label>
                        <input type="number" id="order" name="order" value="{{ old('order', $education->order) }}" min="0">
                ...
                <div class="form-group">
                    <div class="checkbox-group">
                        <input type="checkbox" id="is_active" name="is_active" value="1" {{ old('is_active', $education->is_active) ? 'checked' : '' }}>
                        <label for="is_active">Active</label>
                    </div>
                    <div class="help-text">Only active education entries are shown publicly</div>
                </div>

                <div class="form-actions">
                    <a href="{{ route('admin.education.index') }}" class="btn btn-secondary">Cancel</a>
                    <form method="POST" action="{{ route('admin.education.destroy', $education->id) }}" style="display: inline;" onsubmit="return confirm('Are you sure you want to delete this education entry?')">
                        @csrf
                        @method('DELETE')
